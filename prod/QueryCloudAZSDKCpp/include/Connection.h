...
{
public:
	CloudAZConnection(const std::string& strBaseUrl, const std::string& strPort, const unsigned int msTimeout);
...
public:
	...
	void SetTimeout(unsigned int msTimeout) { _ms_timeout=msTimeout; }
	void Reset();
private:
