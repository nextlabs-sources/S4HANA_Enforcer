...
#ifndef SQLPARSERTEST_RESERVED_WORD_H
#define SQLPARSERTEST_RESERVED_WORD_H


 std::set<std::string,CommonFun::IgnoreCaseCmp> vec_reserved = { //sap reserved
        "AND", "ALL", "ALTER", "AS", "BEFORE", "BEGIN", "BOTH", "CASE", "CHAR", "CONDITION",
        "CONNECT", "CROSS", "CUBE", "CURRENT_CONNECTION", "CURRENT_DATE",
        ...
        "UTCTIMESTAMP", "VALUES", "WHEN", "WHERE", "WHILE", "WITH"
};

#endif //SQLPARSERTEST_RESERVED_WORD_H
