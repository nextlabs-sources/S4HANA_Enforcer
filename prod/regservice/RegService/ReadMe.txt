========================================================================
    ACTIVE TEMPLATE LIBRARY : RegService Project Overview
========================================================================

AppWizard has created this RegService project for you to use as the starting point for
...
RegService.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (RegService.h)
        GUID definitions                                (RegService_i.c)
        A type library                                  (RegService.tlb)
        Marshaling code                                 (RegService_p.c and dlldata.c)

RegService.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in RegService.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named RegService.pch and a precompiled types file named StdAfx.obj.
...
RegServiceps.vcxproj
	...
	dlldata.c, RegService_i.c and RegService_p.c which are required
	to build the proxy/stub DLL.

RegServiceps.vcxproj.filters
